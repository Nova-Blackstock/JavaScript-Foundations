...
//     let denominator = n1 - 1;
//     let monthlyRate = numerator / denominator;
//     console.log(name, ", your monthly rate is $", p*monthlyRate);
...
const mortgageCalculator=(p, interest, years, credit) =>{
    const name = "Nova";
    let i = interest / 12;
    let n = years * 12;
...
variableInterestRate(200000, 0.05, 30, 800)
